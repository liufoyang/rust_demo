...
impl ToString for Token {
    fn to_string(&self) -> String {
        ...
        let format_result = format!("{}, line:{}, column:{}", self.text, self.line_num, self.column_num);
...
impl Lexer_Parser {
            ...
            match self.state {
                ...
                Lexer_State::PrimaryType => {
                    if ch.is_alphabetic()||ch.is_ascii_digit() {
                        ...
                        painc!("not value PrimaryType token {}{}", self.token_text, ch);
                    }
                },
    ...
    fn parseInit(&mut self, ch:char) {
        ...
        panic!("wrong token begin chart for {}", ch);
    }
    ...
    fn state2TokenType(&self) -> Token_Type{
        match self.state {
            ...
            Lexer_State::i32 => Token_Type::i32,
            Lexer_State::i64 => Token_Type::i64,
            Lexer_State::bool => Token_Type::bool,
            Lexer_State::f64 => Token_Type::f64,
            Lexer_State::f32 => Token_Type::f32,
            Lexer_State::string => Token_Type::string,
            Lexer_State::PrimaryType => {
                if self.token_text.as_str() == ":i32" {
                    ...
                    painc!("not value PrimaryType token {", self.token_text);
                }
            },
...
pub fn lexerParse(code:&str) -> TokenList {
    ...
    ,"i32".to_string(),"i64".to_string(),"bool".to_string(), "f32".to_string(), "f64".to_string(), "string".to_string()];
